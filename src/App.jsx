  ...
  <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
    <div className="animate__animated animate__fadeInUp animate__delay-3s">
      ...
      <p className="text-base/loose mb-6 opacity-50">Saya adalah pemula dalam dunia IT yang luas dan penuh peluang. 
        <br />Meski masih di awal perjalanan, 
        saya berkomitmen untuk terus mengasah 
        <br />kemampuan dan mempelajari teknologi baru. 
        Setiap tantangan baru 
        <br />adalah kesempatan bagi saya 
...
<div className="tentang mt-32 py-10" id="tentang">
  <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg" data-aos="fade-up" data-aos-duration="1000" >
    <img src={DataImage.HeroImage} alt="Image" className="w-12 rounded-md mb-15 sm:hidden" loading="lazy" />
    <p className="text-base/loose mb-10">
      Hi, saya Rasyif Ibnu Hasri. Saya sorang mahasiswa jurusan informatika. saya masih pemula dalam dunia IT yang luas, 
      tetapi rasa ingin tahu membuat saya terus belajar dan mencoba hal-hal baru. Saya percaya bahwa teknologi bukan hanya soal tampilannya saja, 
      tetapi juga bagaimana ia memberikan pengalaman terbaik bagi penggunanya. 
      Meskipun perjalanan saya baru dimulai, saya selalu berusaha berkembang dan menghasilkan karya yang lebih baik dari waktu ke waktu.
    </p>
  ...
  <div className="tools mt-32 " >
           ...
           <div>
            ...
            <div className="flex flex-wrap gap-2">
              {proyek.tools.map((tool, index)  => (
                <p className="py-1 px-3 border border-zinc-500 bg-zinc-800 rounded-md font-semibold" key={index}>{tool}</p>
              ))}
            </div>
    ...
    {/*tentang*/}
     ...
     <div className="kontak mt-32 sm:p-10 p-0 " id="kontak">
      ...
      <p className="text-base/loose text-center mb-10 opacity-50"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Mari terkoneksi dengan saya</p>
      <form action="https://formsubmit.co/sragenkota87@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
